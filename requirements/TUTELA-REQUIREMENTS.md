...
| TUT-1712 | `tests/fixtures/praxis-provenance/` (+ `SOURCE.json`); `docs/INTEGRATIONS.md` pending trust-root change | `tests/test_tutela_contribution_provenance.py` (all 56 contract 1.1 cases, ContractRevision11Tests, chain replay, SHA-256 checks) |
